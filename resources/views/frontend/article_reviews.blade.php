...
@section('title')
{{ $pages->meta_title ?? "Article Reviews" }}
@endsection

@section('description')
{{ $pages->meta_description ?? "Article Reviews" }}
@endsection

@section('tags')
{{ $pages->tags ?? "Article Reviews" }}
@endsection
...
<div class="acd_section assits pt-5 pb-5 pt-md-0 pb-md-0">
    <div class="container mt-5">
        ...
        <p class="paras">We have numerous writers that will complete your projects in short order at reasonable rates.
            Papersnerd is here to assist you with numerous services. Some of them are described below:</p>
...
<div class="container" id="section" style="margin-top:5rem;">
    <div class="row">
