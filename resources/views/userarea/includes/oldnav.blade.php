        ...
        <ul id="sidebarnav">
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="{{ route('userarea.orders.index') }}" aria-expanded="false"><i class="mdi mdi-arrange-send-backward"></i><span class="hide-menu">View Orders</span></a>
                <ul aria-expanded="false" class="collapse">
                    <li><a href="{{ route('userarea.orders.index') }}">All Orders</a></li>
                    <li><a href="{{ route('userarea.orders.payment_awaiting') }}">Payment Awaiting</a></li>
                    <li><a href="{{ route('userarea.orders.in_process') }}">In Process </a></li>
                    <li><a href="{{ route('userarea.orders.delivered') }}">Delivered </a></li>
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="{{ route('frontend.order') }}" target="_blank" aria-expanded="false"><i class="mdi mdi-library-plus"></i><span class="hide-menu">Create New Orders</span></a>
            </li>
