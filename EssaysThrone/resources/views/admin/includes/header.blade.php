...
<nav class="navbar top-navbar navbar-expand-md navbar-light">
    ...
    <div class="navbar-header">
        <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
            ...
            <!-- Logo text --><span>
             <!-- dark Logo text -->
             <img src="{{ asset('userend/images/nlogo.png') }}" alt="homepage" class="dark-logo" />
             <!-- Light Logo text -->    
         ...
         <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('admin/assets/images/users/1.jpg') }}" alt="user" class="profile-pic" /></a>
