            ...
            <div class="row gy-5 gx-4">
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex align-items-center mb-3">
                  ...
                  <h6 class="mb-0">Title page & Bibliography</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">APA/MLA formatting</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">Direct contact with the writer</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">Unlimited references</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">24/7 live support</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">Unlimited revisions</h6>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="row gy-5 gx-4">
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">Plagiarism Report</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">One Page Summary</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">A Grammar Check Report</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">Abstract Page</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">Quality Double-check</h6>
                </div>
              </div>
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s">
                <div class="d-flex align-items-center mb-3">
                  <i class="icon-color fa fa-check fa-2x flex-shrink-0 me-3"></i>
                  <h6 class="mb-0">SPSS analysis</h6>
                </div>
              </div>
            </div>
          </div>
